...
func TestLambda_apiGatewayTriggerExample(t *testing.T) {
	...
	exampleDir := "../lambda/examples/api_gateway_trigger/"

	terraformOptions := LambdaTerraformModuleSetupExample(t, functionName, exampleDir, nil)
	t.Logf("Terraform module inputs: %+v", *terraformOptions)
	defer terraform.Destroy(t, terraformOptions)

	LambdaTerraformModuleTerraformApplyAndValidateOutputs(t, terraformOptions)
...
func TestLambda_s3VersioningExample(t *testing.T) {
	...
	functionName := fmt.Sprintf("lambda-%s", random.UniqueId())
	exampleDir := "../lambda/examples/s3_versioning/"
...
func TestLambda_kinesisTriggerBasicExample(t *testing.T) {
	...
	functionName := fmt.Sprintf("lambda-%s", random.UniqueId())
	exampleDir := "../lambda/examples/kinesis_basic/"
...
func TestLambda_kinesisTriggerMultipleExample(t *testing.T) {
	...
	functionName := fmt.Sprintf("lambda-%s", random.UniqueId())
	exampleDir := "../lambda/examples/kinesis_multiple/"
...
func TestLambda_noEnvironmentVariables(t *testing.T) {
	...
	functionName := fmt.Sprintf("lambda-%s", random.UniqueId())
	exampleDir := "../lambda/examples/no_environment_variables/"
...
func TestLambda_layersExample(t *testing.T) {
	...
	functionName := fmt.Sprintf("lambda-%s", random.UniqueId())
	exampleDir := "../lambda/examples/layers/"
...
func TestLambda_publishExample(t *testing.T) {
	...
	functionName := fmt.Sprintf("lambda-%s", random.UniqueId())
	exampleDir := "../lambda/examples/publish/"
...
func TestLambda_cloudwatchEventScheduleTriggerExample(t *testing.T) {
	...
	functionName := fmt.Sprintf("lambda-%s", random.UniqueId())
	exampleDir := "../lambda/examples/cloudwatch_event_schedule_trigger/"
...
func TestLambda_nullTriggerExample(t *testing.T) {
	...
	functionName := fmt.Sprintf("lambda-%s", random.UniqueId())
	exampleDir := "../lambda/examples/null_trigger/"
...
func TestLambda_dockerImageBasic(t *testing.T) {
	...
	functionName := fmt.Sprintf("lambda-%s", random.UniqueId())
	exampleDir := "../lambda/examples/docker_image_basic/"
...
func TestLambda_dockerImageOverrideImageConfig(t *testing.T) {
	...
	functionName := fmt.Sprintf("lambda-%s", random.UniqueId())
	exampleDir := "../lambda/examples/docker_image_override_image_config/"
...
func TestLambda_cloudwatchEventPatternTriggerExample(t *testing.T) {
	...
	functionName := fmt.Sprintf("lambda-%s", random.UniqueId())
	exampleDir := "../lambda/examples/cloudwatch_event_pattern_trigger/"
...
func TestLambda_stepfunctionTriggerExample(t *testing.T) {
	...
	functionName := fmt.Sprintf("lambda-%s", random.UniqueId())
	exampleDir := "../lambda/examples/step_function_trigger/"
...
func TestLambda_cognitoTriggerExample(t *testing.T) {
	...
	functionName := fmt.Sprintf("lambda-%s", random.UniqueId())
	exampleDir := "../lambda/examples/cognito_trigger/"
...
func TestLambda_cloudwatchLogsTriggerExample(t *testing.T) {
	...
	functionName := fmt.Sprintf("lambda-%s", random.UniqueId())
	exampleDir := "../lambda/examples/cloudwatch_logs_trigger/"
...
func TestLambda_sqsTriggerExample(t *testing.T) {
	...
	functionName := fmt.Sprintf("lambda-%s", random.UniqueId())
	exampleDir := "../lambda/examples/sqs_trigger/"
...
func TestLambda_sqsExternalTriggerExample(t *testing.T) {
	...
	functionName := fmt.Sprintf("lambda-%s", random.UniqueId())
	exampleDir := "../lambda/examples/sqs_external_trigger/"

	sqsTargets := []string{"aws_sqs_queue.one", "aws_sqs_queue.two", "aws_sqs_queue.three", "aws_sqs_queue.fifo"}
	sqsTerraformOptions := LambdaTerraformModuleSetupExample(t, functionName, exampleDir, sqsTargets)
...
func TestLambda_sqsSnsTriggerExample(t *testing.T) {
	...
	functionName := fmt.Sprintf("lambda-%s", random.UniqueId())
	exampleDir := "../lambda/examples/sqs_sns_trigger/"
	snsTargets := []string{"aws_sns_topic.foo", "aws_sns_topic.bar", "aws_sns_topic.baz"}

	snsTerraformOptions := LambdaTerraformModuleSetupExample(t, functionName, exampleDir, snsTargets)
...
func TestLambda_sqsFifoTriggerExample(t *testing.T) {
	...
	functionName := fmt.Sprintf("lambda-%s", random.UniqueId())
	exampleDir := "../lambda/examples/sqs_fifo_trigger/"
...
func TestLambda_sqsFifoSnsTriggerExample(t *testing.T) {
	...
	functionName := fmt.Sprintf("lambda-%s", random.UniqueId())
	exampleDir := "../lambda/examples/sqs_fifo_sns_trigger/"
...
func TestLambda_cloudwatchLogSubscriptionExample(t *testing.T) {
	...
	functionName := fmt.Sprintf("lambda-%s", random.UniqueId())
	exampleDir := "../lambda/examples/cloudwatch_logs_subscription/"
...
func LambdaTerraformModuleSetupExample(t *testing.T, functionName string, exampleDir string, targets []string) *terraform.Options {
...
func LambdaTerraformModuleTerraformApplyAndValidateOutputs(t *testing.T, terraformOptions *terraform.Options) {
