...
func TestVPCApplyEnabled_basic(t *testing.T) {
	...
	terraformOptions := VPCTerraformModuleSetupTestCase(t, terraformModuleVars)
	t.Logf("Terraform module inputs: %+v", *terraformOptions)
	defer terraform.Destroy(t, terraformOptions)

	terraform.InitAndApply(t, terraformOptions)
	VPCTerraformModuleValidateTerraformModuleOutputs(t, terraformOptions)
...
func VPCTerraformModuleSetupTestCase(t *testing.T, terraformModuleVars map[string]interface{}) *terraform.Options {
	testRunFolder, err := files.CopyTerraformFolderToTemp("../vpc", t.Name())
...
func VPCTerraformModuleValidateTerraformModuleOutputs(t *testing.T, terraformOptions *terraform.Options) {
