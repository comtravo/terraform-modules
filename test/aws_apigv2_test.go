...
func TestV2APIG_httpAPILambdaProxyBasic(t *testing.T) {
	...
	exampleDir := "../apigv2/examples/http_api_lambda_proxy_basic/"

	terraformOptions := APIGV2SetupExample(t, apigName, exampleDir)
...
func TestV2APIG_httpAPILambdaProxyCORS(t *testing.T) {
	...
	apigName := fmt.Sprintf("apig-%s", random.UniqueId())
	exampleDir := "../apigv2/examples/http_api_lambda_proxy_cors/"
...
func APIGV2SetupExample(t *testing.T, apigName string, exampleDir string) *terraform.Options {
...
func APIGV2TerraformApplyAndValidateOutputs(t *testing.T, terraformOptions *terraform.Options) {
