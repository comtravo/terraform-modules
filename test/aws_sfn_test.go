...
func TestSFN_basic(t *testing.T) {
	...
	exampleDir := "../sfn/examples/basic/"

	terraformOptions := SFNTerraformModuleSetupExample(t, sfnName, exampleDir)
...
func TestSFN_lambda(t *testing.T) {
	...
	sfnName := fmt.Sprintf("sfn-%s", random.UniqueId())
	exampleDir := "../sfn/examples/lambda/"
...
func SFNTerraformModuleSetupExample(t *testing.T, sfnName string, exampleDir string) *terraform.Options {
